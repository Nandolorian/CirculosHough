...
bordes = cv2.Canny(imgGris, 100, 200)
...
# Se calculan los radios min y máx a buscar. En el caso de estudio el radio es fijo
rango_r = np.arange(10, 200, step=1)
...
for x, y, r, v in circulos:
    imgFinal = cv2.circle(imgFinal, (x,y), r, (255,0,0), 1)
